...
Retrieves the English date range for each Nepali month based on a given date.

## getEnglishDateRangeOfNepaliMonth
Retrieves the English date range for specific month based on given date.

## getEnglishDateRangeOfNepaliYear
Retrieves the English date range of a specific year based on a given date.
